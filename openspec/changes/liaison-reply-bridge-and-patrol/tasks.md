> **进度**：32/33（§0 三条门槛 ＋ §1 P0 回件桥＋第九态 ＋ §2 P1 信号与打标即开班 ＋ §3 P2 拆件章程正本全部完成 ＋ §4 P3 口径点台账全部完成并合回 main，2026-09-17 `[Mac]0917H`；§5.1/5.2/5.4 通过，2026-09-17 `[Mac]0917N`，TD-47 已还）。立包 2026-09-10（`[Mac]0909AT`）。需求树见 `intent.md`，裁决 Q1–Q7 见 `design.md` D1–D7。
