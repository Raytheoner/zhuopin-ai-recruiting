...
- [ ] 8.5bis **SDK `message` 事件接线**（2026-09-10 追加；`liaison-reply-bridge-and-patrol` design D6 把接线判给本包，其 tasks §0.2 只做核验）。七件事：
