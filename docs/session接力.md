...
| **R-3** | §5 五条真实起活实测 | `[Mac]0917N`/`0917P` 无头泳道（Cowork·0917D 经 launchd 远程发车；5.4 需他本人手机发一条消息） | ✅ **5.1/5.2/5.4 通过**：5.1 重启 pid 41080→52687→63369，0 新增 ERROR；5.2 先经 `0917N`（TD-47 修复后重跑，止步于陈旧信号）、再经 `0917P`（清假信号后真实章程复验，H0..HEAD 零提交、零越界）两轮确认；5.4 `liaison_message` +1、新增 `bridge_skipped_no_inflight` 一条、无 `dispatch_started`、台账文件 diff 空。详见 `docs/findings/2026-09-17-打标即开班真实起活实测.md`「重跑三（0917N）」与「复验（0917P）」 | 5.3 仍待汤丽萍真实入站；5.5 与归档随 5.3 | 5.3 无真实入站前无法归档 |
