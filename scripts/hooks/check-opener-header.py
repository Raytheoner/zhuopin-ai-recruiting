#!/usr/bin/env python3
"""Claude Code `Stop` hook —— 拦截缺少【OP-MMDD-X】标题行的指令代码块。
...
# 【OP-0826-A】/【OP-MMDD-X】(模板占位) 都算有效抬头
OPENER_HEADER = re.compile(r"【OP-[0-9A-Za-z]+-[0-9A-Za-z]+】")
...
def main() -> int:
    ...
    print(
        "⛔ 指令代码块缺少【OP-MMDD-X】标题行 + 【设置】行（CLAUDE.md「给 Paul "
        "任务指令时的强制格式」）。\n"
